			...
			<table id="cart-table">
				...
				<c:forEach items="${carrinhoCompras.itens }" var="item">
						<tr>
							...
							<td>
								<form:form action="${s:mvcUrl('CCC#remover').arg(0, item.produto.id).arg(1, item.tipo).build()}" method="post">
									<input align="center" type="image" src="${contextPath}resources/imagens/excluir.png" alt="Excluir"
										title="Excluir" />
								</form:form>
							</td>
						</tr>
